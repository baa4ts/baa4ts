...
export const GmailNoScrap = React.memo(() => {
  ...
  return (
    <button
      onClick={copy}
      className="font-mono text-xs text-white/90 border hover-anim border-white/15 rounded-md px-2.5 py-1.5 hover:bg-white/10 hover:border-white/30  flex items-center gap-1.5"
    >
